...
export const deleteProductAction = createAsyncThunk("shop/deleteProductAction", async (data, { getState, dispatch, rejectWithValue }) => {
  console.log("datadeleteproduct", data);
  ...
  try {
    ...
    await _alkamContract.methods
      .removeProduct(data.productUuid)
