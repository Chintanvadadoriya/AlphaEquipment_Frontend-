...
const EquipmentInfo = ({ child }) => {
  ...
  const { formik, selectProduct, setSelectProduct, equipmentType, setEquipmentType, selectAuction, setSelectAuction, screen, isDisabled, shopData, handleChange, moneyType, setMoneyType, loader, setLoader } = useEditProduct();
