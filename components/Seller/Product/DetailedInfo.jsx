...
const DetailedInfo = ({ child }) => {
  const { formikDetail, screen, shopData, isDisabled, loader, setLoader } = useAddProduct();
              ...
              <div className="form-group">
                ...
                >
                  ...
                  {categoryData?.map((data) => (
                    <option key={`${data.id},${data.name}`} value={`${data.id},${data.name}`}>
                      {data.name}
                    </option>
                  ))}
                </Form.Select>
